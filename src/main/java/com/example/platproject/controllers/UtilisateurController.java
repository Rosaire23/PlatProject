...
import com.example.platproject.service.UtilisateurService;
...
public class UtilisateurController {
    ...
    private void openPlatView(Utilisateur utilisateur) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/platproject/Plat.fxml"));
            Parent root = loader.load();
            PlatController platController = loader.getController(); // Obtenez le contrôleur JoueurController à partir du loader
            platController.setUtilisateur(utilisateur); // Passer l'utilisateur connecté au contrôleur JoueurController
    ...
    private void inscrire(){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/platproject/inscription.fxml"));
            //Parent root = loader.load();
    ...
    private void afficherInterfaceConnexion() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/platproject/connexion.fxml"));
            Parent root = loader.load();
            Scene scene = new Scene(root, 900, 700);
